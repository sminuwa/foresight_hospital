...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:03 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow">
							<!-- Item -->
							<h3 class="widget-title">Button tags</h3>
							<p class="margin-l20">Just add the base
								<code>btn btn-primary</code> to any
								<code>&lt;button&gt;</code>
							</p>
						...
						<div class="widget-area-2 proclinic-box-shadow">
							...
							<p class="margin-l20">Just add the base
								<code>btn btn-outline-*</code> to any
								<code>&lt;button&gt;</code>
							</p>
							<div class="proclinic-widget">
							...
							<p class="margin-l20">Just add the class
								<code>btn-lg or btn-sm or btn-block</code> to any
								<code>btn</code> class.
							</p>
							<div class="proclinic-widget">
								<div>
							...
							<div class="widget-area-2 proclinic-box-shadow">
							<!-- Item -->
							<h3 class="widget-title">Active & Disabled state</h3>
							<p class="margin-l20">Just add the class
								<code>active or disabled</code> to any
								<code>btn</code> class.
							</p>
