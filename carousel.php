...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:38 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow">
							<!-- Item -->
							<h3 class="widget-title">Slides only</h3>
							<p class="margin-l20">carousel is a powerful tool for image slides. we need to add <code>class="carousel slide"</code> to div element and add <code>.carousel-item</code> to inside slide.</p>
							...
							<div class="widget-area-2 proclinic-box-shadow">
							<!-- Item -->
							<h3 class="widget-title">With controls</h3>
							<p class="margin-l20">To get previous and next control add <code>data-slide="prev"</code> and <code>data-slide="next"</code>.</p>
							<div class="proclinic-widget">
								<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
									...
									<a class="carousel-proclinic-prev" href="#carouselExampleControls" role="button" data-slide="prev">
										<span class="carousel-proclinic-prev-icon" aria-hidden="true"></span>
										<span class="sr-only">Previous</span>
									</a>
									<a class="carousel-proclinic-next" href="#carouselExampleControls" role="button" data-slide="next">
										<span class="carousel-proclinic-next-icon" aria-hidden="true"></span>
							...
							<div class="widget-area-2 proclinic-box-shadow">
							<!-- Item -->
							<h3 class="widget-title">With indicators</h3>
							<p class="margin-l20">To get carousel indicators add <code>class="carousel-indicators"</code> to <code>ol</code>.</p>
							<div class="proclinic-widget mb-3">
								<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
									...
									<a class="carousel-proclinic-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
										<span class="carousel-proclinic-prev-icon" aria-hidden="true"></span>
										<span class="sr-only">Previous</span>
									</a>
									<a class="carousel-proclinic-next" href="#carouselExampleIndicators" role="button" data-slide="next">
										<span class="carousel-proclinic-next-icon" aria-hidden="true"></span>
										<span class="sr-only">Next</span>
									</a>
								</div>
...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:43 GMT -->
</html>