...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/charts-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:43 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Morris Charts</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h3 class="widget-title">Line Charts</h3>
							<div id="lineMorris" class="chart-one"></div>
						</div>
					</div>
					<!-- /Item -->
					<!-- Item -->
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							...
							<div id="donutMorris" class="chart-one"></div>
						</div>
					</div>
					<!-- /Item -->
					<!-- Item -->
					...
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h3 class="widget-title">Site Visit Charts</h3>
							<ul class="list-inline text-right">
								<li class="list-inline-item">
									<span class="ti-control-record visit-quality"></span> Quality</li>
								<li class="list-inline-item">
									<span class="ti-control-record visit-price"></span> Price</li>
							</ul>
							<div id="visitMorris" class="chart-two"></div>
						</div>
					</div>
					<!-- /Item -->
				</div>	
