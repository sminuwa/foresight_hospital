...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:03 GMT -->
<head>
	<meta charset="utf-8">
	...
	<div class="wrapper">		
		...
		<div id="content">
			...
			<div class="container">				
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 card-area">
							<h3 class="widget-title">Image on top and Bottom</h3>
							<div class="row">
								<!-- Item-->
								<div class="col-sm-6">
									<div class="card">
										<img class="card-img-top" src="images/card-1.jpg" alt="Card image">
										<div class="card-body">
											<h4 class="card-title">Card title</h4>
											<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
											<a class="btn btn-primary btn-sm" href="javascript:void(0)">Go somewhere
											</a>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="card smt-2 mb-3">
										...
										<img class="card-img-bottom" src="images/card-2.jpg" alt="Card image">
									</div>
								</div>
								<!-- /Item-->
							</div>
						...
						<div class="widget-area-2 card-area">
							<h3 class="widget-title">Content Alignment</h3>
							<div class="row">
								<!-- Item-->
								<div class="col-sm-4 mb-3">
									<div class="card">
										<div class="card-body">
											...
											<a class="btn btn-outline-primary btn-sm" href="javascript:void(0)">Go somewhere</a>
										</div>
									</div>
								</div>
								<!-- /Item-->
							...
							<div class="widget-area-2 card-area pb-3">
							<h3 class="widget-title">Background Colors</h3>
							
								<!-- Item-->
									<div class="card card-no-border text-white bg-success text-center smt-2">
								...
								<!-- /Item-->
								<!-- Item-->
									<div class="card card-no-border text-white bg-info text-center smt-2">
										<div class="card-header text-lg">Header</div>
										<div class="card-body">
								...
								<!-- Item-->
									<div class="card card-no-border text-white bg-danger text-center smt-2">
										<div class="card-header text-lg">Header</div>
										<div class="card-body">
...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:23 GMT -->
</html>