...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/charts-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:43 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Flot Charts</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
			...
			<div class="container">
				<div class="row">
					<!-- Item -->
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h5 class="widget-title">Moving Line Chart</h5>
							<div id="movingLineFlot" class="chart-one"></div>
						</div>
					</div>
					<!-- /Item -->
					<!-- Item -->
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h3 class="widget-title">Live Chart</h3>
							<div id="lineFlot" class="chart-one"></div>
						</div>
					</div>
					<!-- /Item -->
					<!-- Item -->
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h3 class="widget-title">Bars Charts</h3>
							<div id="barFlot" class="chart-three"></div>
						</div>
					</div>
					<!-- /Item -->
					<!-- Item -->
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow widget-morris">
							<h3 class="widget-title">Sales Bar Charts</h3>
							<div id="salesBarFlot" class="chart-three"></div>
						</div>
					</div>
					<!-- /Item -->
				</div>
	...
	<!-- Flot charts-->
	<script src="charts/js/jquery.flot.min.js"></script>
	<script src="charts/js/jquery.flot.time.min.js"></script>
	<script src="js/custom-flot.js"></script>
	<!-- Custom Script-->
	<script src="js/custom.js"></script>
</body>


<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/charts-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:56 GMT -->
</html>