...
<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/map-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:40:57 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Google Maps</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow pb-3">
							<h3 class="widget-title">Simple Map</h3>
							<div class="map-box">
					...
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow pb-3">
							<h3 class="widget-title">Map With Marker</h3>
							<div class="map-box">
					...
					<div class="col-md-6">
						<div class="widget-area-2 proclinic-box-shadow pb-3">
							...
							<div class="map-box">
								<div id="routeMap" class="google-map"></div>
							</div>
						</div>
					</div>
					<!-- Map Item -->
	...
	<!-- Google maps-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD5u8QmAP6DxLCQrbI5QnH9Y4n6xLBV2V0"></script>
	<script src="js/custom-gmap.js"></script>
	<!-- Custom Script-->
	<script src="js/custom.js"></script>
</body>


<!-- Mirrored from www.konnectplugins.com/proclinic/Horizontal/map-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Dec 2018 19:41:01 GMT -->
</html>